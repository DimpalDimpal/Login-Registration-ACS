...
$mail->Username = 'dimple@ismt.edu.np';
$mail->Password = 'webdesigner';
// send by email
$mail->setFrom('dimple@ismt.edu.np', 'OTP Verification');
...
?>
<script>
alert("<?php echo "OTP is sent to " . $email ?>");
window.location.replace('reset-code.php'); </script>
<?php
}
}
}
		...
		$sql = $con->query("SELECT password FROM users WHERE email = '$email'");
            ...
            if ($sql->num_rows > 0) {
                ...
                if (password_verify($password, $data['password'])) {
                    ...
                    $errors['password'] = "Old password!! please enter new password.";
